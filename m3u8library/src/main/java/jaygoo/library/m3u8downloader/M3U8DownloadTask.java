    ...
    private void getM3U8Info(String url) {
        ...
        M3U8InfoManger.getInstance().getM3U8Info(url, new OnM3U8InfoListener() {
            ...
            public void onError(Throwable errorMsg) {
                M3U8Log.e("getM3U8Info error-----" + errorMsg.getMessage());
    ...
    private void startDownload(final M3U8 m3U8) {
        ...
        if (!dir.exists()) {
          boolean isSuccess=  dir.mkdirs();
            M3U8Log.d("mkdirs saveDir----" + saveDir);
            M3U8Log.d("mkdirs-----" + isSuccess);
        }
                ...
                public void run() {
                    ...
                    if (!file.exists()) {//下载过的就不管了
                        ...
                        try {
                            ...
                            M3U8Log.e("---- getResponseMessage:"+conn.getResponseCode());
                            if (conn.getResponseCode() == 200) {
                                ...
                                M3U8Log.e("---- getResponseMessage:"+conn.getResponseMessage());
                            }else {
