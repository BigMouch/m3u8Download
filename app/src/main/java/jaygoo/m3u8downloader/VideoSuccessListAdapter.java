 ...
 * ================================================
 */
public class VideoSuccessListAdapter extends ArrayAdapter<String> {


    public VideoSuccessListAdapter(@NonNull Context context, int resource, @NonNull String[] objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        String mediaBean = getItem(position);
        ...
        try {
            urlName.setText(MD5Utils.decode(mediaBean));
        } catch (Exception e) {
            e.printStackTrace();
        }
