 ...
 * ================================================
 */
public class DownloadSuccessListAdapter extends ArrayAdapter<M3U8Task> {

    public DownloadSuccessListAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<M3U8Task> objects) {
